<div align="center">
  ...
  **把电脑里的真实文件，通过局域网安全地交付给身边设备。**
  ...
  当前版本 0.2.3：中英双语界面、无障碍优化、Tauri 2 轻量内核。
...
<img src="docs/screenshots/admin-overview.png" alt="内网闪传控制端总览" width="900">
...
| 中英双语界面 | 管理端与访客端均支持简体中文 / English 即时切换。 |
| 无障碍优化 | 完整键盘导航、焦点陷阱、读屏标签与实时通知。 |
